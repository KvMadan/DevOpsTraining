...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jfRadioButton = __webpack_require__(132).jfRadioButton;

	var jfListSelection = __webpack_require__(133).jfListSelection;

	var jfManageProLicense = __webpack_require__(134).jfManageProLicense;

	var jfManageHaLicenses = __webpack_require__(135).jfManageHaLicenses;

	var jfDragAndDropTxt = __webpack_require__(136).jfDragAndDropTxt;

	var jfNews = __webpack_require__(137).jfNews;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var jfHeaderController = (function () {
	    function jfHeaderController($scope, $q, User, $state, $timeout, $window, GeneralConfigDao, FooterDao, JFrogEventBus, ArtifactoryFeatures, $rootScope, $location, $http, ArtifactoryState, ArtifactoryHttpClient, OnBoardingWizard, GoogleAnalytics) {
	        ...
	        this.defaultLogoUrl = "images/artifactory_logo.307.svg";
	        this.HELP = HELP;
